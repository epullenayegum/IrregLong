...
[![R-CMD-check](https://github.com/epullenayegum/IrregLong/actions/workflows/R-CMD-check.yaml)](https://github.com/epullenayegum/IrregLong/actions/workflows/R-CMD-check.yaml)
<!-- badges: end -->
