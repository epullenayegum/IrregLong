...
## Minor changes
* reverted GEE estimation from geem to geeglm

## Bug fixes
* Examples are now only executed if the nlme package is in the Namespace
* corrected documentation for the argument maxfu
* removed package MEMSS from 'Suggests'
...
* The Liang model now allows for 3time-invariant covariates to be included in the visit process model.
